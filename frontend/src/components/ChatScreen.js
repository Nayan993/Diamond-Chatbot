...
// // ⬇️ IMPORT BACKGROUND + PROFILE IMAGES
...
//     { sender: "bot", text: "Hello! I am Diamond Bot." },
//   ]);
...
//             {msg.sender === "user" && (
//               <img src={userPfp} className="pfp" alt="user" />
//             )}
//           </div>
//         ))}
...
function ChatScreen() {
  ...
  useEffect(() => {
    ...
    // Second message: Diamond Bot intro after 1.5 seconds
